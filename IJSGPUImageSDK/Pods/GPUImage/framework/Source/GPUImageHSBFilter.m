 ...
 */
static void matrixmult(a, b, c) float a[4][4], b[4][4], c[4][4];
{
    int x, y;
    float temp[4][4];
 ...
 */
static void identmat(matrix) float matrix[4][4];
{
 ...
 */
static void xformpnt(matrix, x, y, z, tx, ty, tz) float matrix[4][4];
float x, y, z;
float *tx, *ty, *tz;
{
 ...
 */
static void cscalemat(mat, rscale, gscale, bscale) float mat[4][4];
 ...
 */
static void saturatemat(mat, sat) float mat[4][4];
float sat;
{
    float mmat[4][4];
 ...
 */
static void xrotatemat(mat, rs, rc) float mat[4][4];
float rs, rc;
{
    float mmat[4][4];
 ...
 */
static void yrotatemat(mat, rs, rc) float mat[4][4];
float rs, rc;
{
    float mmat[4][4];
 ...
 */
static void zrotatemat(mat, rs, rc) float mat[4][4];
float rs, rc;
{
    float mmat[4][4];
 ...
 */
static void zshearmat(mat, dx, dy) float mat[4][4];
float dx, dy;
{
    float mmat[4][4];
 ...
 */
static void huerotatemat(mat, rot) float mat[4][4];
float rot;
{
    float mmat[4][4];
    float mag;
