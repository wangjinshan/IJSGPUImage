...
/**
 基类
 */
typedef NS_ENUM(NSUInteger, IJSGPUImageShowcaseFilterType) {
    GPUIMAGE_SATURATION,
    GPUIMAGE_CONTRAST,
    GPUIMAGE_BRIGHTNESS,
    GPUIMAGE_LEVELS,
...
@interface IJSGimageBaseController : UIViewController

@property (nonatomic, strong) GPUImagePicture *gpuPicture;          // 输入对象
@property(nonatomic,strong) GPUImageVideoCamera *videoCamera;  // 输入对象
@property (nonatomic, strong) GPUImageView *gpuImageView;             // 展示数据
@property (nonatomic, strong) GPUImageOutput<GPUImageInput> *filter; // 滤镜1
